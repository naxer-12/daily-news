...
import 'package:daily_news/features/weather_screen/data/datasource/remote_data_source_impl.dart';
import 'package:daily_news/features/weather_screen/data/domain/remote_latest_data_repo_impl.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton<LatestDataRepo>(
    () => RemoteContentPageDataRepoImpl(
      latestDataRepoSource: LatestDataSourceImpl(),
    ),
  );

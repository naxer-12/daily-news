...
class CustomBlurHash extends StatefulWidget {
  ...
  @override
  CustomBlurHashState createState() => CustomBlurHashState();
}

class CustomBlurHashState extends State<CustomBlurHash> {
  ...
  @override
  void didUpdateWidget(CustomBlurHash oldWidget) {
  ...
  Widget build(BuildContext context) => Stack(
    ...
    children: [
      buildCustomBlurHashBackground(),
      if (widget.image != null) prepareDisplayedImage(),
    ],
  );

  Widget prepareDisplayedImage() =>
      Image.network(widget.image, fit: widget.imageFit,
  ...
  Widget buildCustomBlurHashBackground() => FutureBuilder<ui.Image>(
    future: _image,
